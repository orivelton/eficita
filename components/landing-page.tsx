...
export function LandingPage({ onLogin, onTryFree }: LandingPageProps) {
  return (
        ...
        <div className="mx-auto max-w-6xl px-4 pb-20 pt-20 lg:px-8 lg:pt-28 lg:pb-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Button size="lg" onClick={onTryFree} className="w-full px-8 text-sm sm:w-auto">
                Experimentar gratis
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
                ...
                <Button
                  ...
                  variant="ghost"
                  onClick={onLogin}
                  className="w-full px-8 text-primary-foreground/80 hover:bg-primary-foreground/10 hover:text-primary-foreground sm:w-auto"
                >
                  Ja tenho conta
                </Button>
              </div>
