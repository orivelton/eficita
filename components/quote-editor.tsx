...
export function QuoteEditor({
    ...
    history: initialQuote.history || [
      {
        ...
        note: "Orcamento criado",
      },
    ],
    templateId: initialQuote.templateId || "classico",
  }))
  ...
  const handleTemplateSelect = useCallback((templateId: QuoteTemplateId) => {
    setQuote((prev) => ({ ...prev, templateId }))
  ...
  return (
    <div className="flex h-dvh flex-col bg-background overflow-hidden">
      ...
      <header className="flex items-center justify-between border-b border-border bg-card px-4 py-2.5">
        ...
        <div className="flex items-center gap-2">
          <TemplateButton
            currentTemplate={quote.templateId || "classico"}
          ...
          >
            ...
            <span className="hidden sm:inline">
              {showPreview ? "Formulario" : "Preview"}
            </span>
          </Button>
