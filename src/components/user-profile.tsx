...
import { updateProfile, changePassword, type AuthUser } from '@/lib/auth'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { Label } from '@/components/ui/label'
import { Card } from '@/components/ui/card'
import { Switch } from '@/components/ui/switch'
import { User, Mail, Building2, Lock, Eye, EyeOff, Save, Bell, Palette, Shield } from 'lucide-react'
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-lg bg-secondary/50 px-3.5 py-2.5">
                ...
                <p className="mt-0.5 text-xs font-medium text-foreground">
                  Pro <span className="text-primary">(Ativo)</span>
                </p>
              </div>
            </div>
          </div>
